...
//
// The changes are in the characters generated and also allows the resulteDate to
...
/// then padding characters are added so the resulteDate length is a multiple of 4.
//
/// Returns:
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
