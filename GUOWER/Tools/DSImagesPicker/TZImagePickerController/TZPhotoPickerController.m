...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *item = [[UIBarButtonItem alloc] initWithTitle:tzImagePickerVc.cancelBtnTitleStr style:UIBarButtonItemStylePlain target:tzImagePickerVc action:@selector(cancelButtonClick)];
    [item setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:m_FontPF_Regular_WithSize(17),NSFontAttributeName,m_Color_gray(47),NSForegroundColorAttributeName, nil] forState:UIControlStateNormal];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TZImagePickerController *tzImagePickerVc = (TZImagePickerController *)self.rt_navigationController;
...
- (void)takePhoto {
    ...
    if ((authStatus == AVAuthorizationStatusRestricted || authStatus ==AVAuthorizationStatusDenied) && iOS7Later) {
        ...
        if (iOS8Later) {
            ...
            MMAlertView *alert = [[MMAlertView alloc]initWithTitle:[NSBundle tz_localizedStringForKey:@"Can not use camera"] detail:message items:@[MMItemMake([NSBundle tz_localizedStringForKey:@"Cancel"], MMItemTypeNormal, nil),MMItemMake([NSBundle tz_localizedStringForKey:@"Setting"], MMItemTypeNormal, ^(NSInteger index) {
                
                if (index == 1) { // 去设置界面，开启相机访问权限
                    if (iOS8Later) {
            ...
            MMAlertView *alert = [[MMAlertView alloc]initWithTitle:[NSBundle tz_localizedStringForKey:@"Can not use camera"] detail:message items:@[MMItemMake([NSBundle tz_localizedStringForKey:@"Cancel"], MMItemTypeNormal, nil),MMItemMake([NSBundle tz_localizedStringForKey:@"OK"], MMItemTypeNormal, ^(NSInteger index) {
