                 ...
                 inputHandler:(MMPopupInputHandler)inputHandler
{
    ...
    if ( self )
    {
        ...
        if ( title.length > 0 )
        {
            ...
            self.titleLabel.font = m_FontPF_Regular_WithSize(config.titleFontSize);
        ...
        if ( detail.length > 0 )
        {
            ...
            self.detailLabel.font = m_FontPF_Regular_WithSize(config.detailFontSize);
        ...
        for ( NSInteger i = 0 ; i < items.count; ++i )
        {
            ...
            btn.titleLabel.font = (item==items.lastObject)?m_FontPF_Regular_WithSize(config.buttonFontSize):m_FontPF_Regular_WithSize(config.buttonFontSize);
        }
